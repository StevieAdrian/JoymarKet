...
public class Customer extends User {
	...
	public Customer(String idUser, String fullName, String email, String password, String phone, String address, String gender) {
	...
	public static boolean updateBalance(String idCustomer, double amount) {
		String query = "UPDATE customers SET balance = balance - ? WHERE idUser = ?";
